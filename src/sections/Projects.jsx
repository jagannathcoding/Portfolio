...
const Projects = () => {
  ...
  return (
    <section className="py-16 px-8 mt-24"> {/* Add margin-top for correct scroll position */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {/* Project 1 */}
        <div
          className={`card shadow-xl rounded-xl transform transition-all duration-500 bg-gradient-to-r from-${primaryColor} via-${secondaryColor} to-${accentColor} hover:scale-105 hover:shadow-2xl hover:rotate-2`}
          data-aos="fade-up"
          data-aos-delay="300"
        >
          <div className="card-body text-center p-6">
            <h3 className={`text-3xl font-semibold text-${accentColor} mb-4`}>
              To-do App
            </h3>
            ...
            <a
              href="#"
              className={`py-3 px-6 rounded-full bg-${primaryColor} text-${accentColor} hover:bg-${secondaryColor} hover:text-white transition-all duration-300 ease-in-out shadow-lg`}
            >
              View Project
            </a>
          </div>
